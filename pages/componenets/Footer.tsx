...
function Footer(props) {
  ...
  <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
    ...
    <a className=" cursor-pointer flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
     <img src="/popcorn.svg" width="40vw"/>
      <span className="ml-3 text-white text-xl">PinoyMovieBlog</span>
    </a>
    </Link>
   
    <p className="text-sm sm:ml-5 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© 2020 PinoyMovieBlog 
  ...
  <Link href="/">
    ...
    <Link href="/about">
    <a href="#" className="md:ml-24 ml-5  text-white  text-sm font-medium" aria-current="page">About us</a>
    </Link>
    <Link href="/contact">
    <a href="#" className="md:ml-24 ml-5  text-white  text-sm font-medium" aria-current="page">Contact Us</a>
    </Link>
    <Link href="/privacy-policy">
    <a href="#" className="md:ml-24 ml-5   text-white  text-sm font-medium" aria-current="page">Privacy Policy</a>
    </Link>
    <Link href="/disclaimer">
    <a href="#" className="md:ml-24 ml-5  text-white  text-sm font-medium" aria-current="page">Disclaimer</a>
    </Link>
