...
function Post(props) {
    ...
    return (
        ...
        <div className="flex md:px-10 px-5 py-5 md:py-10 flex-wrap justify-between  -mx-6">
            <div 
            onClick={()=>{
            ...
            className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-lg">
                    <a href="#" className="flex flex-wrap no-underline hover:no-underline">
                        ...
                        <p className="w-full text-gray-600 hover:text-blue-500 text-xs md:text-sm px-6">GETTING STARTED</p>
