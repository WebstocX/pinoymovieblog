...
const CustomModal:React.FC<CustomModalProps> = () => {
  return (
    ...
    <div className="md:hidden fixed z-10 inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
      <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
       
        <div className="fixed inset-0 bg-white bg-opacity-100 transition-opacity" aria-hidden="true"></div>
